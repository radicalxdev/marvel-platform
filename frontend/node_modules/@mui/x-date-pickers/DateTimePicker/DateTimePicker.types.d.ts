...
export interface DateTimePickerSlotsComponents<TDate> extends DesktopDateTimePickerSlotsComponent<TDate>, MobileDateTimePickerSlotsComponent<TDate> {
}
export interface DateTimePickerSlotsComponentsProps<TDate> extends DesktopDateTimePickerSlotsComponentsProps<TDate>, MobileDateTimePickerSlotsComponentsProps<TDate> {
}
export interface DateTimePickerProps<TDate> extends DesktopDateTimePickerProps<TDate>, MobileDateTimePickerProps<TDate> {
    /**
