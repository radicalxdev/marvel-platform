      ...
      return {
        ...
        Background: {
          ...
          gradient: {
            ...
            purple2: 'linear-gradient(286.17deg, #6335F8 0%, #E71DE7 100%)',
            purple2Reverse:
              'linear-gradient(286.17deg, #E71DE7 0%, #6335F8 100%)',
            purple3Reverse:
              'linear-gradient(286.17deg, transparent 15%, #E71DE7 25%, #6335F8 60%)',
            purple4: '#5614F3',
            brown:
            ...
            variants: [
              {
                ...
                style: {
                  ...
                  '&:hover': {
                    ...
                    boxShadow:
                      globalTheme.customShadows.Elevation.PrimaryHover
                        .boxShadow,
                    color: 'rgba(255, 255, 255, 0.87)',
                  },
                  '&:disabled': {
              ...
              },
              {
                ...
                style: {
                  ...
                  '&:hover': {
                    background:
                      globalTheme.palette.Background.gradient.blueDark,
                    boxShadow:
              ...
              },
              {
                ...
                style: {
                  ...
                  boxShadow:
                    globalTheme.customShadows.Elevation.Error.boxShadow,
                  color: 'rgba(255, 255, 255, 0.87)',
                  '&:hover': {
                    background:
                      globalTheme.palette.Background.gradient.errorDark,
                    boxShadow:
            ...
            styleOverrides: {
              label: {
                ...
                '&.Mui-disabled': {
                  ...
                  lineHeight: globalTheme.typography['Body 1'].lineHeight,
                  textDecoration:
                    globalTheme.typography['Body 1'].textDecoration,
                  textTransform: globalTheme.typography['Body 1'].textTransform,
                },
              },
              root: { marginLeft: '0px' },
          ...
          MuiFilledInput: {
            styleOverrides: {
              root: {
                ...
                textDecoration:
                  globalTheme.typography.Components['Input Text']
                    .textDecoration,
                textTransform:
